...
const Footer = () => {
    ...
    // ==================== List Data Store =============================
    const listI = [
        {id: 1, name: "How to Specifice", link: "/how-to-Specify"},
        {id: 2, name: "AI Marketplace", link: "/talent-marketplace"},
        {id: 3, name: "Project Catalog", link: "/services"},
        {id: 4, name: "Engine Scout", link: "/staffing"},
        {id: 5, name: "Specify and Agency", link: "#"},
        {id: 6, name: "Enterprise", link: "/enterprise"},
        {id: 7, name: "Specify Worldwide", link: "#"},
    ];

    const listII = [
        {id: 1, name: "How to save time", link: "/how-to-find-work"},
        {id: 2, name: "Direct relation", link: "#"},
        {id: 3, name: "Find Help Worldwide", link: "#"},
    ];

    const listIII = [
        {id: 1, name: "Help & Support", link: "#"},
        {id: 2, name: "Chat-gpt", link: "/success-stories"},
        {id: 3, name: "AI Genie Review", link: "#"},
