...
const SuccessStories = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            {/* ============== Head Tag =============== */}
            <HeadTag title="Success Stories | AI Genie"/>
                ...
                <div className="container mx-auto lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3 pb-10 border-b border-zinc-300">
                    ...
                    >
                        ...
                        <p className="font-semibold lg:text-xl text-lg text-zinc-600">
                            See how AI Genie helps businesses like yours grow and succeed.
                        </p>
                    </motion.div>
                </div>
            </header>
                    ...
                    <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-7 gap-y-7 mt-7">
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <div className="mt-3">
                                <h2 className="text-zinc-800 font-semibold text-xl cursor-pointer">
                                    Why Remote Work Is the Strength Behind AI Genie’s Social Media Team
                                </h2>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-3">
                                <h2 className="text-zinc-800 font-semibold text-xl cursor-pointer">
                                    How Engineering Teams Use AI Genie To Scale
                                </h2>
                            </div>
                        </div>
                         ...
                         <div>
                            ...
                            <div className="mt-3">
                                <h2 className="text-zinc-800 font-semibold text-xl cursor-pointer">
                                    How Customer Service Teams use AI Genie to Scale
                                </h2>
                            </div>
                        </div>
                         ...
                         <div>
                            ...
                            <div className="mt-3">
                                <h2 className="text-zinc-800 font-semibold text-xl cursor-pointer">
                                    How Marketing Teams Use AI Genie To Scale
                                </h2>
                            </div>
                        </div>
