...
const AllJobs = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Freelance All Jobs - AI Genie"/>
                    ...
                    <div className="flex">
                        ...
                        <aside className={`xl:w-[25%] lg:w-[30%] 2xl:pr-10 sm:pr-8 pr-7 lg:pl-0 sm:pl-8 pl-7 lg:py-0 py-5 lg:relative absolute lg:bg-transparent bg-[#F3FFFC] lg:z-0 z-[5] lg:shadow-none shadow-2xl lg:border-none border sm:left-auto left-0 lg:rounded-none sm:rounded-l-xl rounded-r-lg transition ${(showFilter == true) ? "translate-x-0" : "lg:translate-x-0 translate-x-[-150%]"}`}>
                            ...
                            <div className="py-4 border-b-2 border-zinc-200 mt-1">
                                ...
                                {clientHistory && <div>
                                    <div className="flex space-x-3 my-4 items-center">
                                        <input id="no-s" type="checkbox" value="" className="w-5 h-5 text-blue-600 bg-transparent rounded border-gray-300 focus:ring-blue-500 focus:ring-2 cursor-pointer"/>
                                        <label htmlFor="no-s" className="text-zinc-800 cursor-pointer">
                                            No  <span className="text-sm text-zinc-600"> (6) </span>
                                        </label>
                                    </div>

                                    <div className="flex space-x-3 my-4 items-center">
                                        <input id="onetonine-s" type="checkbox" value="" className="w-5 h-5 text-blue-600 bg-transparent rounded border-gray-300 focus:ring-blue-500 focus:ring-2 cursor-pointer"/>
                                        <label htmlFor="onetonine-s" className="text-zinc-800 cursor-pointer">
                                            1 to 9 s <span className="text-sm text-zinc-600"> (8) </span>
                                        </label>
                                    </div>

                                    <div className="flex space-x-3 my-4 items-center">
                                        <input id="tenplus-s" type="checkbox" value="" className="w-5 h-5 text-blue-600 bg-transparent rounded border-gray-300 focus:ring-blue-500 focus:ring-2 cursor-pointer"/>
                                        <label htmlFor="tenplus-s" className="text-zinc-800 cursor-pointer">
                                             <span className="text-sm text-zinc-600"> (9) </span>
                                        </label>
                                    </div>
                                </div>}
                            </div>
