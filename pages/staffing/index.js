    ...
    const GlobalTalent = [
        {
            ...
            text: '"AI Genie has taken my business to the next level. Through AI Genie, I have engaged with many high quality clients that I would not have been exposed to by my own means." '
        },

        {
            ...
            text: '"I was able to triple my income because of AI Genie. I love the chance I have to learn and grow my business through the platform."'
        },

        {
            ...
            text: '"I wake up every day and get to do work I love because of AI Genie. Ive worked over 8,000 hours on AI Genie and it barely feels like it because I love what I do"'
        },

        {
            ...
            text: '"AI Genie has proven to be the best way for me to find high-quality clients and exciting work."'
        },

        {
            ...
            text: '"My goal in 2021 is to reach $1M in earnings on AI Genie. That said, I am very grateful for the opportunity that AI Genie has created for professionals. '
        },
    ];
                        ...
                        <div className="2xl:space-y-7 lg:space-y-5 space-y-4">
                            ...
                            >
                                <h4 className="text-zinc-800 xl:text-xl text-lg font-semibold">
                                    Navigate  with an expert on your side
                                </h4>
                    ...
                    <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                        <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                            ...
                            <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                                It's the quick way to highly-qualified talent – and with very little effort on your part.
                            </p>
                        </div>
