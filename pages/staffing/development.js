...
const Development = () => {
    ...
    const TalentWorks = [
...

        {
            id: 3,
            number: 3,
            head: "Review and match your talent",
            des: "Interview the top matches, see who’s a match, or get another shortlist"
        }
    ];
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="IT Staffing Solutions: Get Top Development & IT Talent with AI Genie"/>
                ...
                <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
                    <div className="lg:px-10 xl:px-7">
                        ...
                        <p className="lg:mt-5 mt-3 text-zinc-600 sm:text-lg">
                            It all starts with a conversation—we’ll work with you to find out what hard and soft skills you’re looking for, quickly zero in on a shortlist of candidates, and guide your through the  process.
                        </p>
                    ...
                    {/* ================ This is alwayse same not change =================== */}
                        ...
                        <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                            ...
                            <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                                ...
                                <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                                    With Talent Scout, specialized recruiters take the time-consuming sifting and sorting out of tech  by quickly sourcing the most qualified engineers, developers, and architects for your needs, pre-screened and ready to work.
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col justify-between lg:space-y-10 space-y-5 md:mt-1 mt-2 lg:col-span-2">
                            <div>
                                <h2 className="lg:text-4xl text-2xl text-gray-100 font-semibold">
                                    Development Let's talk about your tech  needs.
                                </h2>
                            </div>
