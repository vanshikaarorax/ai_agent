...
const Development = () => {
    ...
    const TalentWorks = [
...

        {
            id: 3,
            number: 3,
            head: "Review an your talent",
            des: "Interview the top matches, see who’s a , or get another shortlist"
        }
    ];
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Marketing Staffing Solutions: Get Top Marketing Talent with AI Genie"/>
                    ...
                    {/* ================ This is alwayse same not change =================== */}
                        ...
                        <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                            ...
                            <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                                ...
                                <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                                    You’ll be able to perfect highly-qualified talent quickly — and with very little effort on your part. With Talent Scout, specialized recruiters take the time-consuming sifting and sorting out of  creative talent by quickly sourcing the most qualified designers and creatives for your needs, pre-screened and ready to work.
                                </p>
                            </div>
