...
const HowToFindWork = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="How Does Upwork Work for Freelancers | AI Genie"/>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 xl:gap-x-20 lg:gap-x-16 md:gap-x-7 items-center md:mt-14">
                        ...
                        >
                            ...
                            <p className="text-zinc-600 sm:text-lg text-md lg:mt-5 mt-3">
                                Search on AI Marketplace™ for the hourly or fixed-price work you’re looking for. Submit a proposal, set your rate, and show how great you’ll be. Give a little extra by sharing your unique approach and offering a rapport-building interview.
                            </p>
