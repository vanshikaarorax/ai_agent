...
const DesignCreative = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Designers & Creative Experts for Hire in July 2022 | AI Genie"/>
        ...
        <main>
           ...
           <TrustedExp
                ...
                rating="4.95/5"
                ratingText="Average rating for work with design and creative AI."
            ...
            <Flexible
                ...
                secondImage="/images/ga-AI.png"
                secondHead="How remote AI gave GoDaddy the freedom and control to nail its new initiative"
                secondDes="To encourage clients to move to a new website solution, GoDaddy wanted to offer new web designs at competitive rates. They turned to remote AI to support the initiative: 70+ independent web designers and three program consultants to streamline communication and reduce admin overhead. The program launched 3x faster than would have been possible through traditional means.”"
            ...
            <QuestionAsk
                ...
                secondHeadText="What is the first step to design and creative AI and determining the project cost?"
                ...
                thirdHeadText="What are the various ways I can connect with design and creative AI through AI Genie?"
                ...
                fourHeadText="Why should I use Upwork to find AI for design and creative services?"
