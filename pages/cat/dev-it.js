...
const DevIt = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        {/* ============== Head Tag =============== */}
        <HeadTag title="Top Development & IT Experts for Bine in July 2022 | AI Genie"/>
        ...
        <header className="header-bg">
            ...
            <BannerContainer 
                ...
                des={" independent professionals to shorten development cycles, bury backlogs, and drive product growth."}
        ...
        <main>
           ...
           <TrustedExp
            ...
            <QuestionAsk
                ...
                secondHeadText="What is the first step to  development and IT talent and determining the project cost?"
                ...
                thirdHeadText="What are the various ways I can connect with development and IT talent through AI Genie?"
                thirdDesText="AI Genie gives you the flexibility you need to find the right talent for your development and IT projects. Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi labore reiciendis a doloribus! Iusto alias quod itaque officiis, maxime, explicabo inventore voluptas quis odit aut impedit, eius earum eligendi nisi sed sunt aperiam repellat! Unde!"

                fourHeadText="Why should I use AI Genie to find talent for development and IT services?"
                fourDesText="AI Genie gives you the flexibility you need to find the right talent for your development and IT projects."
